  ...
  return L.divIcon({
    ...
    html: `
      <div style="position:relative;display:flex;align-items:center;justify-content:center;">
        ...
        <span style="position:relative;display:flex;align-items:center;justify-content:center;width:20px;height:20px;border-radius:9999px;background:${meta.color};border:2px solid rgba(23,21,31,0.9);font-size:9px;font-weight:700;color:#17151F;">${place.summary.wait}</span>
      </div>`,
    iconSize: [34, 34],
    iconAnchor: [17, 17],
  });
